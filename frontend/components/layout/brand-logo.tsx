    ...
    <Link href="/" className="inline-flex min-w-0 items-center gap-2.5 sm:gap-3">
      {hasLogo ? (
        <img
          ...
          className="h-10 w-10 rounded-2xl object-cover shadow-[0_12px_26px_rgba(239,139,30,0.24)] sm:h-11 sm:w-11"
        />
      ) : (
        <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-[radial-gradient(circle_at_top_left,#fff2d3,#ef8b1e)] shadow-[0_12px_26px_rgba(239,139,30,0.24)] sm:h-11 sm:w-11">
          <span className="text-lg font-black text-brand-deep">F</span>
        </span>
      )}
      <span className="flex min-w-0 flex-col">
        <span className="truncate font-display text-xl leading-none text-brand-deep sm:text-2xl">
